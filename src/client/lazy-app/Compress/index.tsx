      ...
      <div class={style.compress}>
        ...
        <button class={style.back} onClick={onBack}>
          <svg viewBox="0 0 61 53.3">
            ...
            <path
              class={style.backX}
              d="M21.458 37.458L19.542 35.542L29.042 26L19.542 16.458L21.458 14.542L31 24.042L40.542 14.542L42.458 16.458L32.958 26L42.458 35.542L40.542 37.458L31 27.958L21.458 37.458Z"
            />
          </svg>
        </button>
        {mobileView ? (
